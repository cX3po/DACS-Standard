...
type PricingSpec =
  ...
  //   minPct, maxPct are non-negative percentage deltas around bandCenter.
  //   Invariant: minPct >= 0 and maxPct >= 0, and the computed lower bound
  //   (bandCenter.amount * (1 - minPct/100)) MUST be > 0. Band bounds round
  //   half-up to bandCenter.amount's CD-1 (§8.5.1) fractional-digit count.
  //   See §8.5.2 for the exact band arithmetic and boundary semantics.
